<form method="post" action="options.php" enctype="multipart/form-data">
	...
	<table class="form-table">
		...
		<tr class="wrap-icon-bg-color" valign="top">
			...
			<td><input type="text" name="popupbtn" id="popupbtn" value="<?php echo ul_pro_get_option('popupbtn') ?>" /></td>
		</tr>
		<tr class="wrap-icon-bg-color" valign="top">
...
<div class="container">
	<div class="row">
		...
		<fieldset class="woo_fieldset">
			...
			<p>You just need to put the shortcode wherever you want <code>[property]</code></p>
			<p>If you want product from specific category you can use<code>[property category="lunch"]</code></p>
			<p>If you want product count you can use <code>[property category="lunch" count="6"]</code></p>
		</fieldset>
	</div>
</div>